'''
Implementación del ataque MITM si g = p - 1.
...
print("La clave pública de Bob es (1 o p-1): {B}".format(B=B))
...
cipher2 = AES.new(key, AES.MODE_CBC, iv)
m3 = cipher2.decrypt(c)

print("El mensaje recuperado de Alicia con S = 1 es: {m2}".format(m2=m2))
print("El mensaje recuperado de Alicia con S = p - 1 es: {m3}".format(m3=m3))